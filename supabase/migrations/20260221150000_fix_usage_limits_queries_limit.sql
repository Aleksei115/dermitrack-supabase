-- Fix: queries_limit column has no default and INSERT omits it
-- Add a default value AND fix the RPC to include it

ALTER TABLE chatbot.usage_limits ALTER COLUMN queries_limit SET DEFAULT 20;
