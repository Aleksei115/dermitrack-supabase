-- Fix audit_visit_graph: remove reference to dropped visita_odvs table
-- visita_odvs was replaced by saga_zoho_links (already included per-saga in this function)
